...
ListView::widget([
    ...
    'itemView' => function ($model, $key, $index, $widget) use ($tab) {
        ...
        $link =
            $tab !== 'profile'
                ? Html::a('', '', ['class' => 'popupModal btn btn-danger btn-sm pull-right glyphicon glyphicon-trash',
                'data-toggle' => 'modal',
                'data-target' => '#modal',
                'data-id' => $model->login]) : '';
        if ($tab === 'income') {
            $link =
                Html::a('', '/'
                            ...
                            . $model['login']
                            . '/'
                            . $model['course'], ['class' => 'btn btn-success btn-sm pull-right glyphicon glyphicon-plus']);
        }

        return '<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6">
            <div class="thumbnail friend-card" '
               . ViewHelper::friendOnline($model)
               . '>
                <img src="'
               . $model->image_url
               . '" class="img-card">
               ...
               . '
                    <a href="'
               . Url::to('/' . Yii::$app->language . "/$model->course/$model->login")
