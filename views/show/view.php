...
<div class="container xlogin">
    <div class="row"> <div class="col-lg-12 mx-auto">
            <div class="progress my-shadow" style="margin: 0.75rem auto ;">
                <div class="progress-bar bg-info bg-warning progress-bar-striped progress-bar-animated" role="progressbar" style="width: 67.095238095238%">
                    14.09            </div>
            </div>
        </div>
        <div class="col-lg-3 mx-auto">
            <div class="card" style="width: 100%;">
                <img class="card-img-top " src="https://cdn.intra.42.fr/users/apakhomo.jpg" alt="">
                <div class="card-body">
                    <h5 class="card-title">Artem Pakhomov</h5>
                    <p class="card-text"><b>Login:</b> apakhomo</p>
                    <p class="card-text"><b>Level:</b> 14.09</p>
                    <p class="card-text"><b>Name:</b> Artem Pakhomov</p>
                    <p class="card-text"><b>Phone:</b> <a style="color:#000;" href="tel:+380500279300">+380500279300</a></p>
                    <p class="card-text"><b>Email:</b> apakhomo@student.unit.ua</p>
                    <p class="card-text"><b>Pool year:</b> 2017</p>
                    <p class="card-text"><b>Pool month:</b> september</p>
                    <p class="card-text"><b>Wallet:</b> 185</p>
                    <p class="card-text"><b>Grade:</b> Captain</p>
                    <p class="card-text"><b>Correction Point:</b> 32</p>
                    <p class="card-text"><b>Achivements:</b> 48</p>
                    <p class="card-text"><b>Host:</b> e2r11p12</p>
                    <p class="card-text"><b>Last login:</b> 1 day ago</p>
                    <p class="card-text"><b>Hours at cluster:</b> 2102.97</p>
                    <a href="//profile.intra.42.fr/users/apakhomo" target="_blank" class="btn btn-warning">Intra</a>
                    <a href="/pool/apakhomo/" class="btn btn-success">Pool Profile</a>
                    <div id="apakhomo"><a class="btn btn-success addfr" onclick="ga('send', 'event', 'friend', 'add');" name="apakhomo">ADD FRIEND</a></div>
                </div>
            </div>
            <div class="card" style="width: 100%;">
                <div class="card-body">
